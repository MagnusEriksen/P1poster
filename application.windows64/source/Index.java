...
public void movieEvent(Movie m) {//for video
  m.read();
}
...
class button {
  ...
  public void testDisplay() { //for testing location of invisible buttons
    if (over == true) {
  ...
  public void update() {//for corner rectangular area (default)
  ...
  public void centerUpdate() {//for center mode rectangle area
  ...
  public void settings() {  size (1503, 771); }
